...
async def run_bridge() -> None:
    """Main bridge loop: start assistant subprocess and relay output."""
    ...
    # Read stdout line by line and publish TA signals
    ...
    try:
        ...
        log.info("Bridge shut down (assistant exit code: %s)", proc.returncode)
