"""context_cleaner.py — Text-cleaning utility for LLM consumption.

Extracted from context-preprocessor/preprocessor.py so openclaw can
import it directly without a network hop.  The preprocessor service
directory is kept for reference but no longer runs as a container.
